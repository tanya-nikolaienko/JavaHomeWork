package com.pb.nikolaenko.hw12;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.fasterxml.jackson.databind.module.SimpleModule;
//import com.pb.nikolaenko.hw11.LocalDateTimeDeserializer;
...
public class PhoneBook {
    ...
    public void add() {
        ...
        subscribers.add(new Subscriber("Олег","22.09.1975","09312345678", "Нью-Йорк", localDateTime));
        System.out.println("Контакт успешно добавлен");
       /* subscribers.stream()
                .collect(Collectors.groupingBy(Subscriber::getName))
    ...
    public void show() {
        if (!subscribers.isEmpty ( )) {
            ...
            if (choice == 1) { /*
                ...
                subscribers.stream()
                        .collect(Collectors.groupingBy(Subscriber::getAddress))
                        .entrySet().forEach(System.out::println);
*/
                subscribers.stream()
                        .sorted(Comparator.comparing(Subscriber::getAddress))
            ...
            if (choice == 2) {/*
                ...
                System.out.println ( );*/
                subscribers.stream()
                        .sorted(Comparator.comparing(Subscriber::getPhone))
                        .forEach(System.out::println);
            }
